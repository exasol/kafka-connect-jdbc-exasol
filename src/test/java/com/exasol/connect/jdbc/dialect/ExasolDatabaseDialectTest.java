...
public class ExasolDatabaseDialectTest extends BaseDialectTest<ExasolDatabaseDialect> {
    ...
    public void shouldBuildAlterTableStatement() {
        ...
        String[] sql = { "ALTER TABLE \"myTable\" ADD \"c1\" DECIMAL(10,0) NOT NULL",
                ...
                "ALTER TABLE \"myTable\" ADD \"c3\" CLOB NOT NULL", "ALTER TABLE \"myTable\" ADD \"c4\" CLOB NULL",
    ...
    public void shouldBuildUpsertStatement() {
        String expected = "MERGE INTO \"myTable\" AS target USING "
                ...
                + "WHEN MATCHED THEN UPDATE SET " + "\"columnA\"=incoming.\"columnA\",\"columnB\"=incoming.\"columnB\","
                + "\"columnC\"=incoming.\"columnC\",\"columnD\"=incoming.\"columnD\" " + "WHEN NOT MATCHED THEN INSERT "
                + "(\"columnA\",\"columnB\",\"columnC\",\"columnD\",\"id1\",\"id2\") " + "VALUES "
    ...
    public void createOneColOnePk() {
        verifyCreateOneColOnePk("CREATE TABLE \"myTable\" (" + System.lineSeparator()
                + "\"pk1\" DECIMAL(10,0) NOT NULL," + System.lineSeparator() + "PRIMARY KEY(\"pk1\"))");
    }

    @Test
    public void createThreeColTwoPk() {
        verifyCreateThreeColTwoPk("CREATE TABLE \"myTable\" (" + System.lineSeparator()
                + "\"pk1\" DECIMAL(10,0) NOT NULL," + System.lineSeparator() + "\"pk2\" DECIMAL(10,0) NOT NULL,"
                + System.lineSeparator() + "\"col1\" DECIMAL(10,0) NOT NULL," + System.lineSeparator()
                + "PRIMARY KEY(\"pk1\",\"pk2\"))");
    }
    ...
    public void upsert1() {
        ...
        String expected = "MERGE INTO \"Customer\" AS target "
                ...
                + "ON (target.\"id\"=incoming.\"id\") " + "WHEN MATCHED THEN UPDATE SET "
        ...
        String sql = dialect.buildUpsertQueryStatement(customer, columns(customer, "id"),
